...
from core.database.models.meeting import Meeting, MeetingDao, MeetingDelete, MeetingStatus
from core.database.models.transcription import (
    Delete,
    Status,
    Transcription,
    TranscriptionDao,
...
class MeetingListRequest(BaseModel):
    ...
    page_size: int = 10
    meeting_name: str | None = None
    status: int | None = None  # 按会议状态过滤：0进行中 1解析中 2解析完成 -1异常
