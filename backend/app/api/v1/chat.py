...
from core.database.models.chat_session import ChatSession, ChatSessionDao
from core.database.models.chatmessage import ChatMessageDao
from core.database.models.user import User
from services.chat_service import stream_chat_messages
from core.llm.client import llm_service
...
async def insert_chat_message(chat_message: ChatMessageAdd, current_user: User = Depends(get_current_user)):
    ...
    - turn_index: 轮次序号
    """
    from rag.memory import persist_chat_message
