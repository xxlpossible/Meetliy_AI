...
import type { MeetingItem, KnowledgeItem } from '@/api/types'
    ...
    <div class="modal">
      <div class="modal-header">
        <div>
          ...
          <p class="modal-subtitle">选择本次对话需要参考的会议和知识库</p>
        </div>
        ...
        <div class="select-section">
          ...
          <div v-else>
            <div :class="{ 'select-list-fetching': chatStore.meetingsLoading }">
              <transition-group name="list" tag="div" class="select-option-list">
                <div
